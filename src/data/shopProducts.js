export default [
    {
        ...
        features: [
            { name: 'Жылдамдық', value: '750 RPM' },
            { name: 'Қуат Көзі', value: 'Сымсыз-Электр' },
            { name: 'Қуат Элемент Түрі', value: 'Литий' },
            { name: 'Кернеу', value: '20 Вольт' },
            { name: 'Батарея Сыйымы', value: '2 Ah' },
        ],
        options: [],
    },
    {
    ...
    {
        id: 12,
        name: 'Ash\'s Шынжырлы аралар 3.5kW',
        price: 666.99,
        compareAtPrice: null,
