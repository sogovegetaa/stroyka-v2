    ...
    return (
        <div className={`block post post--layout--${layout}`}>
            <div className={`post__header post-header post-header--layout--${layout}`}>
                ...
                <h1 className="post-header__title">Жарты шар аралық ауру Лобортис Эгеттің Ұлы орны болуды айтады</h1>
                <div className="post-header__meta">
                    <div className="post-header__meta-item">
                    Авторы
                        <Link to="/">Джессика Мур</Link>
                    </div>
                    <div className="post-header__meta-item"><Link to="/">30 қараша 2023</Link></div>
                    <div className="post-header__meta-item"><Link to="/">4 пікір</Link></div>
                </div>
            </div>
                ...
                <div className="post__tags-share-links">
                    ...
                    <div className="post__share-links share-links">
                        <ul className="share-links__list">
                            <li className="share-links__item share-links__item--type--like"><Link to="/">Ұнайды</Link></li>
                            <li className="share-links__item share-links__item--type--tweet"><Link to="/">Tweet</Link></li>
                            <li className="share-links__item share-links__item--type--pin"><Link to="/">Бекіту</Link></li>
                ...
                <form>
                    <div className="form-row">
                        <div className="form-group col-md-4">
                            ...
                            <input type="text" className="form-control" id="comment-first-name" placeholder="Аты - жөні " />
                        </div>
                        <div className="form-group col-md-4">
                            <label htmlFor="comment-last-name">Тегі</label>
                            <input type="text" className="form-control" id="comment-last-name" placeholder="Тегі" />
                        </div>
                        <div className="form-group col-md-4">
                            <label htmlFor="comment-email">Электрондық пошта</label>
                            <input type="email" className="form-control" id="comment-email" placeholder="Электрондық пошта" />
                        </div>
                    </div>
                    ...
                    <div className="form-group mt-4">
                        <button type="submit" className="btn btn-primary btn-lg">Пікір жазу</button>
                    </div>
                </form>
            </section>
        </div>
