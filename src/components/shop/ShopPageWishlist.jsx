...
function ShopPageWishlist(props) {
    ...
    if (wishlist.length) {
        const itemsList = wishlist.map((item) => {
            ...
            const renderAddToCarButton = ({ run, loading }) => {
                ...
                return <button type="button" onClick={run} className={classes}>Себетке қосу</button>;
            };
                    ...
                    <table className="wishlist">
                        <thead className="wishlist__head">
                            <tr className="wishlist__row">
                                <th className="wishlist__column wishlist__column--image">Сурет</th>
                                <th className="wishlist__column wishlist__column--product">Өнім</th>
                                <th className="wishlist__column wishlist__column--stock">Қорлардың жай-күйі</th>
                                <th className="wishlist__column wishlist__column--price">Бағасы</th>
                                <th className="wishlist__column wishlist__column--tocart" aria-label="Себетке қосу" />
                                <th className="wishlist__column wishlist__column--remove" aria-label="Жою" />
                            </tr>
                        </thead>
            ...
            <div className="block block-empty">
                <div className="container">
                    <div className="block-empty__body">
                        <div className="block-empty__message">Сіздің тілектер тізіміңіз бос!</div>
    ...
    return (
        <React.Fragment>
            <Helmet>
                <title>{`Тілектер тізімі — ${theme.name}`}</title>
            </Helmet>
