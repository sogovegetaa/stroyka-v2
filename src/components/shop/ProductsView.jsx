            ...
            <div className="products-view">
                <div className="products-view__options">
                    <div className={viewOptionsClasses}>
                        ...
                        <div className="view-options__legend">98 өнімнің 6-сы көрсетілген</div>
                        <div className="view-options__divider" />
                        <div className="view-options__control">
                            <label htmlFor="view-options-sort">Сұрыптау</label>
                            <div>
                                <select className="form-control form-control-sm" name="" id="view-options-sort">
                                    <option value="">Әдепкі</option>
                                    <option value="">Аты (А-Я)</option>
                                </select>
                            </div>
                        </div>
                        <div className="view-options__control">
                            <label htmlFor="view-options-limit">Көрсету</label>
                            <div>
