                        ...
                        <div className="about-us__body">
                            ...
                            <div className="about-us__team">
                                ...
                                Біздің тату командада жұмыс істегіңіз келе ме?
                                    <br />
                                    <Link to="/site/contact-us">Бізбен хабарласыңыз</Link>
                                    {' '}
                                    біз сіздің кандидатураңызды қарастырамыз.
                                </div>
                                <div className="about-us__teammates teammates">
                                    <SlickWithPreventSwipeClick {...slickSettings}>
                                        <div className="teammates__item teammate">
                                            ...
                                            <div className="teammate__position text-muted">Атқарушы директор</div>
                                        </div>
                                        <div className="teammates__item teammate">
                                            <div className="teammate__avatar">
                                            ...
                                            <div className="teammate__position text-muted">Маркетинг маманы</div>
                                        </div>
                                        <div className="teammates__item teammate">
                                            <div className="teammate__avatar">
                                            ...
                                            <div className="teammate__position text-muted">Қаржы директоры</div>
                                        </div>
