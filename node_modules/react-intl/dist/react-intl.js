...
(function (global, factory) {
    ...
    */
    ...
    function createFormattedComponent(name) {
      var Component = function Component(props) {
        return React.createElement(Context.Consumer, null, function (intl) {
          invariantIntlContext(intl);
          var formattedValue = intl[name](props.value, props);
    ...
    function formatDate(_ref2, state) {
    ...
    function formatTime(_ref4, state) {
      var locale = _ref4.locale,
          formats = _ref4.formats,
          onError = _ref4.onError,
          timeZone = _ref4.timeZone;

      for (var _len2 = arguments.length, _ref3 = new Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2; _key2 < _len2; _key2++) {
        _ref3[_key2 - 2] = arguments[_key2];
      }
    ...
    function formatRelativeTime(_ref6, state) {
      var locale = _ref6.locale,
          formats = _ref6.formats,
          onError = _ref6.onError;

      for (var _len3 = arguments.length, _ref5 = new Array(_len3 > 2 ? _len3 - 2 : 0), _key3 = 2; _key3 < _len3; _key3++) {
        _ref5[_key3 - 2] = arguments[_key3];
      }

      var value = _ref5[0],
          _ref5$ = _ref5[1],
          unit = _ref5$ === void 0 ? 'second' : _ref5$,
          _ref5$2 = _ref5[2],
          options = _ref5$2 === void 0 ? {} : _ref5$2;
      var format = options.format;
    ...
    function formatNumber(_ref8, state) {
      var locale = _ref8.locale,
          formats = _ref8.formats,
          onError = _ref8.onError;

      for (var _len4 = arguments.length, _ref7 = new Array(_len4 > 2 ? _len4 - 2 : 0), _key4 = 2; _key4 < _len4; _key4++) {
        _ref7[_key4 - 2] = arguments[_key4];
      }

      var value = _ref7[0],
          _ref7$ = _ref7[1],
          options = _ref7$ === void 0 ? {} : _ref7$;
      var format = options.format;
    ...
    function formatPlural(_ref10, state) {
      var locale = _ref10.locale,
          onError = _ref10.onError;

      for (var _len5 = arguments.length, _ref9 = new Array(_len5 > 2 ? _len5 - 2 : 0), _key5 = 2; _key5 < _len5; _key5++) {
        _ref9[_key5 - 2] = arguments[_key5];
      }

      var value = _ref9[0],
          _ref9$ = _ref9[1],
          options = _ref9$ === void 0 ? {} : _ref9$;
    ...
    function areIntlLocalesSupported(locales, constructorsToCheck) {
      ...
      if (!constructorsToCheck) {
        constructorsToCheck = [Intl.DateTimeFormat, Intl.NumberFormat, Intl.PluralRules];
      }
