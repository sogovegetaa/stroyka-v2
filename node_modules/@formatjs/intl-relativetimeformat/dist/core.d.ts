import { LocaleData, FormattableUnit } from './types';
...
export default class RelativeTimeFormat {
    ...
    toString(): string;
    static supportedLocalesOf: (locales: string | string[], __1_0: Pick<IntlRelativeTimeFormatOptions, "localeMatcher"> | undefined) => string[];
